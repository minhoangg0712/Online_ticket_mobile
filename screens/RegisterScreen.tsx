...
title: { 
  ...
  button: { backgroundColor: '#ff7e42', padding: 12, borderRadius: 5, marginTop: 10 },
  buttonText: { color: '#fff', textAlign: 'center', fontWeight: 'bold' },
  error: { color: 'red', fontSize: 12 },
  message: { color: '#ff7e42', marginTop: 5, textAlign: 'center' },
  toggle: { color: '#007bff', fontSize: 13, marginTop: 5 },
  iconEye: {
  position: 'absolute',
  right: 10,
  top: '50%',
